...
/*   Updated: 2019/02/21 17:19:51 by pp               ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	print_fps(t_param *p)
{
	...
	last_time = clock();
	mlx_string_put(p->mlx.init, p->mlx.window, 10, 30, 0x00FFFFFF, "fps ");
	mlx_string_put(p->mlx.init, p->mlx.window, 120, 30, 0x00FFFFFF, fps);
	free(fps);
}
